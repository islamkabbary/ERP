        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="container-fluid clearfix">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block" style="cursor: pointer">Copyright © ERB-ISLAM 2022</span>
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center" style="cursor: pointer">ERB-ISLAM</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
